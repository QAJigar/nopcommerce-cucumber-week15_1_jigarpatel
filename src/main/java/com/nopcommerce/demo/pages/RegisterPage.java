...
public class RegisterPage extends Utility {
    ...
    public String getFirstNameFieldErrorMessage() {
       log.info("Get firstname field error message" + firstNameFieldErrorMessage.toString());
        return getTextFromElement(firstNameFieldErrorMessage);
    }

    public String getLastNameFieldErrorMessage() {
       log.info("Get lastname field error message" + lastNameFieldErrorMessage.toString());
        return getTextFromElement(lastNameFieldErrorMessage);
    }

    public String getEmailFieldErrorMessage() {
        log.info("Get email field error message" + emailFieldErrorMessage.toString());
        return getTextFromElement(emailFieldErrorMessage);
    }

    public String getPasswordFieldErrorMessage() {
   log.info("Get password field error message" + passwordFieldErrorMessage.toString());
    ...
    public String getRegisterSuccessMessage() {
       log.info("Get registration successful message" + successfulRegistrationMessage.toString());
